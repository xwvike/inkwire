...
func TestDisplayListReplayMatchesImmediateCanvas(t *testing.T) {
	...
	direct.FillEllipse(image.Rect(2, 17, 17, 29), InkBlack)
	direct.DrawArc(image.Rect(20, 17, 35, 31), 30, 230, StrokeStyle{Ink: InkRed, Width: 1})
	direct.FillPie(image.Rect(37, 17, 50, 30), -90, 130, InkRed)
	direct.FillChord(image.Rect(52, 17, 66, 30), 10, 220, InkBlack)
	...
	direct.StrokeEllipse(image.Rect(51, 43, 61, 52), StrokeStyle{Ink: InkBlack, Width: 2})
	...
	list.FillEllipse(image.Rect(2, 17, 17, 29), InkBlack)
	list.DrawArc(image.Rect(20, 17, 35, 31), 30, 230, StrokeStyle{Ink: InkRed, Width: 1})
	list.FillPie(image.Rect(37, 17, 50, 30), -90, 130, InkRed)
	list.FillChord(image.Rect(52, 17, 66, 30), 10, 220, InkBlack)
	...
	list.StrokeEllipse(image.Rect(51, 43, 61, 52), StrokeStyle{Ink: InkBlack, Width: 2})
